...
function atualizarSacola() {
  ...
  sacola.forEach((item, index) => {
    ...
    div.innerHTML = `
      <span>${item}</span>
      <button class="btn-remove" onclick="removerDaSacola(${index})">
      Remover
      </button>
    `;
  ...
  cupomMsg.innerHTML =
  "💡 Ao utilizar este método de compra você ganha <strong>10% de desconto</strong>.";
